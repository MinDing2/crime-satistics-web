...
.listGroupTitle {
  ...
  font-size: 20px;
    ...
    input[type="number"] {
        width: 100%;
        padding: 8px;
        margin-bottom: 10px; /* Add some bottom margin for spacing between input fields */
        border: 1px solid #ccc;
        border-radius: 4px;
    }
   ...
   <main style="display: flex; width: 65%; margin: 0 auto;">
      ...
      <div class="rightArea" style="flex: 4;">
         <div class="grayContainer">
          ...
          <!-- 여기에 콘텐츠 넣어보자 -->
          <div>
            <h2 style="padding:10px;">카테고리 수정</h2>
          </div>
			    <form action="/menus/update" method="POST">
			     ...
			     <table>
			     	...
			     	<tr>
			     		<td>메뉴 카테고리</td>
			     		<td><input type="number" name="menu_cate" min="1" max="2" value="${menuVo.menu_cate}" /></td>
			     	</tr>
			     	<tr>
			     		<td colspan="2">
