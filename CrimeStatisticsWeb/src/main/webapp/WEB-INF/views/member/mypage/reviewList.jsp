	...
	<main style="display: flex; width: 65%; margin: 0 auto;">
		...
		<div class="rightArea" style="flex: 4;">
			...
			<div style="margin-bottom: 50px;">
				<h1>내가 쓴 총 리뷰 ${reviewCnt}개</h1>
			</div>
			<c:forEach items="${reviewList}" var="review">
			    <div class="review-box">
			    	<div style="display: flex; justify-content: space-between;">
			    		<a href="/shop/view?n=${review.pdNum}" style="color: black; font-weight: bold; text-decoration: none; font-size: 21px;">
				            ${review.pdName} &gt;
				        </a>
				        <button type="button" class="btn btn-danger btn-sm delete-review"
				        data-reviewid="${review.reviewid}" data-memberid="${review.memberid}">리뷰 삭제</button>
			    	</div>
			        <div class="rate" style="display: inline-block; margin-top: 10px; margin-bottom: 20px;">
			            <span style="width: ${review.rating * 20}%;"></span>
			            <p style="margin-left: 135px;">${review.reviewDate}</p>
			        </div>
			        
			        <br>
			        <div style="display: inline-block;">
			        	<div style="margin-bottom: 10px;">${review.reviewText}</div>
			            <div style="width: 100px;">
			            	<c:if test="${review.reviewImg ne null}">
