		...
		<div class="rightArea" style="flex: 4;">
			...
			<div class="verticalSplit">
			    ...
			    <div class="container mt-5">
			        <h2 class="text-center">작성한 게시물</h2>			        
			        ...
			        <table>
			            ...
			            <tbody>
			                <c:forEach var="myboard" items="${myboardList}">
			                    <tr>
			                        <td style="font-weight: bold; width: 70px;">${myboard.bnum}</td>
			                        <td style="width: 300px;">
			                            <a href="/board/view?bnum=${myboard.bnum}" style="text-decoration: none; color:black;">
			                                ${myboard.title}
			                            </a>
			                        </td>
			                        <td style="width: 150px;">${myboard.writer}</td>
			                        <td style="width: 200px;">${myboard.regdate}</td>			                        
			                        <td style="width: 80px;">
	...
	<script>
		$(document).ready(function(){
		    ...
		    $('.close').on('click', function() {
		        var bnum = $(this).closest('tr').find('td:eq(0)').text();
		        $.ajax({
                    url: '/board/delete',
                    type: 'POST',
					data:{
                    ...
                    success: function () {
                        ...
                        location.href="/member/mypage/myboard";
                    },
                    error: function () {
                        // 삭제 실패 시 실행할 동작
                        alert('게시물 삭제 실패');
		    ...
		    $('.updateform').on('click', function() {
		    	var bnum = $(this).closest('tr').find('td:eq(0)').text();
		    	location.href = '/board/updateform?bnum=' + bnum;
		    })
		});
